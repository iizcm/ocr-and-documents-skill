...
cp -r productivity/ocr-and-documents ~/.hermes/skills/productivity/ocr-and-documents/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/ocr-and-documents-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/ocr-and-documents-skill.git ~/.hermes/skills/productivity/ocr-and-documents/
```
...
```text
skill_view(name="productivity/ocr-and-documents")
```
...
```text
Use the ocr and documents skill to <describe your specific task here>
```
...
```text
Gunakan skill ocr and documents untuk <deskripsikan tugas spesifik Anda di sini>
```
